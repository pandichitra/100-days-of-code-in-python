...
DAY 2:(https://replit.com/@PC10/PandiChitra-Day-02-Tip-Calculator):
 ...
 1)Usage of underscore_ for largenumbers was insightful and it treats like a normal integer(<-- two spaces)
 3)Applied the f string,type conversion , data type matching (else we can't concatenate) , type error and type checking
